...
\begin{spacing}{1.5}
物理的に時間の関数になることがわかっているような時系列データなどはともかく、 \\
...
- 明示的な測定誤差
    - 被度階級を誤る過程を明示的にモデル化 (被度0も含む, Irvine et al. 2019)
...
`transformed parameters`ブロック (再パラメータ化)
